...
from antmed_crm.api.views import get_views
from antmed_crm.fcrm.doctype.crm_form_script.crm_form_script import get_form_script
from antmed_crm.utils import is_frappe_version
