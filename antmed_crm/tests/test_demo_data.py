...
class TestDemoData(FrappeTestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		from antmed_crm.demo.api import clear_demo_data
	...
	def test_demo_data_lifecycle(self):
		from antmed_crm.demo.api import clear_demo_data, create_demo_data
		from antmed_crm.demo.users import DEMO_USERS
