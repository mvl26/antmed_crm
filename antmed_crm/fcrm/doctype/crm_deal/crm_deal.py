...
from antmed_crm.fcrm.doctype.crm_service_level_agreement.utils import get_sla
from antmed_crm.fcrm.doctype.crm_status_change_log.crm_status_change_log import add_status_change_log
from antmed_crm.fcrm.doctype.utils import add_or_remove_lost_reason_section_in_sidepanel
...
class CRMDeal(Document):
	...
	if TYPE_CHECKING:
		...
		from antmed_crm.fcrm.doctype.crm_contacts.crm_contacts import CRMContacts
		from antmed_crm.fcrm.doctype.crm_products.crm_products import CRMProducts
		from antmed_crm.fcrm.doctype.crm_rolling_response_time.crm_rolling_response_time import (
			CRMRollingResponseTime,
		)
		from antmed_crm.fcrm.doctype.crm_status_change_log.crm_status_change_log import CRMStatusChangeLog
